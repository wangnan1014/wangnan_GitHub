...
import com.heag.rcpc.mapper.PcResultMapper;
import com.heag.rcpc.model.PcAskinfo;
import com.heag.rcpc.model.PcResult;
import com.heag.rcpc.model.PcResultExample;

public class PcResultDaoImpl implements IPcResultDao {
	@Autowired
	private PcResultMapper pcResultMapper;
	public Integer countByExample(PcResultExample pre) {
		// TODO Auto-generated method stub
		return pcResultMapper.countByExample(pre);
	}
	...
	public String insertSelective(PcResult pr) {
		...
		return pcResultMapper.insertSelective(pr)+"";
	}
	...
	public ArrayList<PcAskinfo> getPersonAnswer(PcResult pr) {
		// TODO Auto-generated method stub
		return (ArrayList<PcAskinfo>) pcResultMapper.getPersonAnswer(pr);
	}
