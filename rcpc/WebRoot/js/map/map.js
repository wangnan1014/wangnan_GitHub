            ...
            return SVGMap.prototype.options = {
                ...
                function sharpHover(a, b) {
                    ...
                    if (opt.external && "undefined" != typeof self.externalData[b.id].eventHoverLock && 0 != self.externalData[b.id].eventHoverLock || -1 == opt.clickedRegion.indexOf(b.id) && b.animate({
                        ...
                        opt.timeTimer = 1, 0 == $("#MapTip").length && $(document.body).append('<div id="MapTip" class="panel"  style="position:absolute;text-align: center; border:1px solid #337ab7;color:#337ab7"><div class="con"></div><div class="arrow"><div class="arrowMask"></div></div></div'), $("#MapTip .con").html(opt.mapTipHtml(stateData, b));
